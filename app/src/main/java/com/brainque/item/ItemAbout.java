...
public class ItemAbout {
    ...
    private String appNativeOnOff;
    private String appNativeId;
    private String appBannerType;
    private String appFullType;
    private String appNativeType;

    public String getAppNativeOnOff() {
        return appNativeOnOff;
    }

    public void setAppNativeOnOff(String appNativeOnOff) {
        this.appNativeOnOff = appNativeOnOff;
    }
    ...
    public void setAppNativeId(String appNativeId) {
        this.appNativeId = appNativeId;
    }
    ...
    public String getAppFullType() {
        return appFullType;
    }

    public void setAppFullType(String appFullType) {
        this.appFullType = appFullType;
    }

    public String getAppNativeType() {
        return appNativeType;
    }

    public void setAppNativeType(String appNativeType) {
        this.appNativeType = appNativeType;
    }

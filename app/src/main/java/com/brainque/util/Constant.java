...
import com.brainque.cookry.BuildConfig;
...
public class Constant implements Serializable {
    ...
    public static final String LATEST_RECIPE_TOTAL_RATE = "total_users";
    public static final String LATEST_RECIPE_URL = "video_url";
    public static final String RECIPE_FAV = "is_favourite";
    ...
    public static String SAVE_ADS_NATIVE_ON_OFF,SAVE_NATIVE_ID,SAVE_BANNER_TYPE,SAVE_FULL_TYPE,SAVE_NATIVE_TYPE,SAVE_NATIVE_CLICK_OTHER,
            SAVE_NATIVE_CLICK_CAT,SAVE_TAG_LINE,SAVE_ADS_BANNER_ID,SAVE_ADS_FULL_ID,SAVE_ADS_BANNER_ON_OFF,SAVE_ADS_FULL_ON_OFF="false",SAVE_ADS_PUB_ID,SAVE_ADS_CLICK;

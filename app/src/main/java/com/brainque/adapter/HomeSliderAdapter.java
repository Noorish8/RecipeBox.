...
public class HomeSliderAdapter extends RecyclerView.Adapter<HomeSliderAdapter.ItemRowHolder> {
    ...
    public HomeSliderAdapter(Activity context, ArrayList<ItemLatest> dataList) {
    ...
    public void onBindViewHolder(final ItemRowHolder holder, final int position) {
        ...
        holder.text_cat.setText(singleItem.getRecipeCategoryName());
    ...
    public class ItemRowHolder extends RecyclerView.ViewHolder {
        ...
        private TextView text_cat, text_title;
        ...
        private ItemRowHolder(View itemView) {
            ...
            text_cat = itemView.findViewById(R.id.text_cat_title);

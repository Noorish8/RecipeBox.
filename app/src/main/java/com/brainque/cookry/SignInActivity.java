...
public class SignInActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSkip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignInActivity.this, ActivityMain.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            }
    ...
    public void setResult() {
        ...
        if (Constant.GET_SUCCESS_MSG == 0) {
            ...
            if (iswhichscreen) {
                ...
                Intent i = new Intent(SignInActivity.this, ActivityMain.class);
                startActivity(i);
                finish();
            }
        ...
        GraphRequest graphRequest = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                try {
                    ...
                    if (JsonUtils.isNetworkAvailable(SignInActivity.this)) {
                        new MyTaskLoginSocial(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
                        Log.e("login2", "" + API.toBase64(jsObj.toString()));
                    } else {
                        showToast(getString(R.string.no_data_found));
                    }
                } catch (JSONException e) {
                    try {
                        ...
                        if (JsonUtils.isNetworkAvailable(SignInActivity.this)) {
                            new MyTaskLoginSocial(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
                            Log.e("login1", "" + API.toBase64(jsObj.toString()));
                        } else {
                            showToast(getString(R.string.no_data_found));
                        }
